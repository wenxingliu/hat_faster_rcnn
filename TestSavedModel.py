...
path_to_test_images_dir = "D:\\project3_faster_rcnn\\models-master\\research\\hat_dataset\\test_image\\"

IMAGE_SIZE = (12, 8)
image_output_path = "D:\\project3_faster_rcnn\\models-master\\research\\hat_dataset\\test_output\\" + models[i]+"\\"
if os.path.exists(image_output_path) == 0:
    os.makedirs(image_output_path)

# detect_image(path_to_test_images_dir, image_output_path, detection_graph)
