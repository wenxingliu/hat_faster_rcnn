...
if __name__ == "__main__":
    xml_file_path = 'D:\\project3_faster_rcnn\\models-master\\research\\hat_dataset\\annotations\\2k_hat_xmls\\'
    classes = ["hat", "no_hat"]  # 应添加所有的class name
    train_test_list_txt__dir = 'D:\\project3_faster_rcnn\\models-master\\research\\hat_dataset\\hat_dataset_yolo3\\'
